        ...
        <div class="relative z-20 px-4 py-24 mx-auto text-center text-white max-w-7xl lg:py-32">
            <div class="flex flex-wrap text-white">
                <div class="relative w-full px-4 mx-auto text-center xl:flex-grow-0 xl:flex-shrink-0">
                    ...
                    <h1 class="mt-0 mb-2 text-4xl font-bold text-white sm:text-5xl lg:text-7xl">Laravel Perpendek URL</h1>
        ...
        <div class="relative z-30 h-48 px-10 bg-white lg:h-32">
            <form onsubmit="return false;"
                ...
                <div class="w-full h-full lg:w-auto">
                    <button type="submit"
                        class="inline-flex items-center justify-center w-full h-full px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-green-600 border border-transparent rounded-md shadow-sm hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600 lg:w-64">Ambil URL</button>
                </div>
            </form>
        </div>
